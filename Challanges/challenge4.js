...
const differenceDays = differenceMillseconds / (1000 * 3600 * 24 * 365);
console.log(`We verschillen + ${differenceDays} jaar van elkaar.`);

// const differenceDays = differenceDays.toFixed(0); hoe rond ik af?
